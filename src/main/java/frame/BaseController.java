...
public class BaseController extends HttpServlet {
    ...
    public UserRoleService userRoleService = new UserRoleServiceImpl();
    public RolePermissionService rolePermissionService = new RolePermissionServiceImpl();
    public SelectionService selectionService = new SelectionServiceImpl();
    public CourseService courseService =  new CourseServiceImpl();
    public CurriculumService curriculumService = new CurriculumServiceImpl();
     ...
     *
     */
    private static final long serialVersionUID = 5800814578947074688L;
    ...
    public void service(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            throw new RuntimeException(
                    "您要调用的方法：" + methodName + "(HttpServletRequest,HttpServletResponse)，它不存在！");
        }
