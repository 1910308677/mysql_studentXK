...
<div class="rightinfo">
    ...
    <div class="tools">
        ...
        <ul class="toolbar">
            <li class="click"><span><img src="<%=basePath%>static/images/t01.png"/></span><a
                    href="<%=basePath%>view/system/role/addRole.jsp">添加</a></li>
            <li class="click"><span><img src="<%=basePath%>static/images/t02.png"/></span><a
                    href="<%=basePath%>view/system/role/updateRole.jsp">修改</a></li>
    ...
    <table class="tablelist">
        ...
        <tr>
            ...
            <th>角色ID<i class="sort"><img src="<%=basePath%>static/images/px.gif"/></i></th>
            <th>名称</th>
            <th>状态</th>
        ...
        <c:forEach items="${roleList_db}" var="role">
            ...
            <tr>
                ...
                <td>${role.state}</td>
            <td>
                <a href="<%=basePath%>roleController.do?method=delete&roleIdSTR=${role.roleId}">删除</a>
                <a href="<%=basePath%>roleController.do?method=updateUI&roleIdSTR=${role.roleId}">修改</a>
                <a href="<%=basePath%>permissionController.do?method=fpPermissionUI&roleIdSTR=${role.roleId}">分配权限</a>
            </td>
            </tr>
