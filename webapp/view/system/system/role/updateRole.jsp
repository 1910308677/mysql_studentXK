...
<div class="formbody">
    ...
    <form action="<%=basePath%>roleController.do?method=update" method="post">
        ...
        <ul class="forminfo">修改
            <li><label>名称</label><input name="name" type="text" class="dfinput"  value="${role_db.name}"/><i>标题不能超过30个字符</i></li>
            <li><label>状态</label><input name="state" type="text" class="dfinput"  value="${role_db.state}"/><i>标题不能超过30个字符</i></li>
