...
<div class="formbody">
    ...
    <form action="<%=basePath%>courseController.do?method=update" method="post">
        ...
        <ul class="forminfo">修改
            ...
            <li><label>上课时间</label><input name="curriculum" type="text" class="dfinput"  value="${course_db.time}"/><i>标题不能超过30个字符</i></li>
            <li><label>学分</label><input name="teacher" type="text" class="dfinput"  value="${course_db.credit}"/><i>标题不能超过30个字符</i></li>
