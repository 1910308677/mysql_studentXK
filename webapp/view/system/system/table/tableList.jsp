...
<%--            <li><span><img src="<%=basePath%>static/images/t03.png"/></span>删除</li>--%>
            <li><span><img src="<%=basePath%>static/images/t04.png"/></span>选课课表</li>
        </ul>
...
<%--            <th>操作</th>--%>
        ...
        <tbody>
        <c:forEach items="${tableList_db}" var="curriculum">
            <tr>
            <tr>
...
<%--                <td>--%>
<%--                    <a href="<%=basePath%>countController.do?method=delete&curriculumIdSTR=${curriculum.userId}"></a>--%>
<%--                </td>--%>
            </tr>
