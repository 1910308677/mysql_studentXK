...
<div class="rightinfo">
    ...
    <div class="tools">
        ...
        <ul class="toolbar">
            <li class="click"><span><img src="<%=basePath%>static/images/t01.png"/></span><a
                    href="<%=basePath%>permissionController.do?method=addUI">添加</a></li>
    ...
    <table class="tablelist">
        ...
        <tr>
            ...
            <th>权限ID<i class="sort"><img src="<%=basePath%>static/images/px.gif"/></i></th>
            <th>父ID</th>
            <th>名称</th>
            <th>类别</th>
            <th>URL</th>
        ...
        <c:forEach items="${permissionList_db}" var="permission">
            ...
            <tr>
                ...
                <td>
                    <a href="<%=basePath%>permissionController.do?method=delete&permissionIdSTR=${permission.permissionId}">删除</a>
                    <a href="<%=basePath%>permissionController.do?method=updateUI&permissionIdSTR=${permission.permissionId}">修改</a>
                </td>
            </tr>
